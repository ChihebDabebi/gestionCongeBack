...
public class NotificationMail {
    ...
    public static void sendAccepted(EmailSenderService senderService , String toEmail){
    ...
    public static void sendRefused(EmailSenderService senderService, String toEmail){
        senderService.sendEmail(toEmail,"demande de congé","Bonjour,\n\n" +
